...
class JacksonCoreProcessorSpec extends Specification {
    ...
    void "test big decimal"() {
        ...
        given:
        JacksonCoreProcessor processor = new JacksonCoreProcessor(false, new JsonFactory(), JsonConfig.DEFAULT)
    ...
    void "test big decimal - USE_BIG_DECIMAL_FOR_FLOATS"() {
        ...
        given:
        def cfg = JsonConfig.DEFAULT.withUseBigDecimalForFloats(true)
    ...
    void "test big integer - USE_BIG_INTEGER_FOR_INTS"() {
        ...
        given:
        def cfg = JsonConfig.DEFAULT.withUseBigIntegerForInts(true)
        JacksonCoreProcessor processor = new JacksonCoreProcessor(false, new JsonFactory(), cfg)
        BigInteger bInt = new BigInteger("9223372036854775807")
    ...
    void "test nested arrays"() {
        given:
        JacksonCoreProcessor processor = new JacksonCoreProcessor(true, new JsonFactory(), JsonConfig.DEFAULT)
