...
@SerializableBean(allowSerialization = false)
@JsonSubTypes({
...
''')
        //def serializer = ((Serializer.Factory) compiled.loadClass('example.$Base$Serializer$Factory').newInstance()).newInstance(null, null)
