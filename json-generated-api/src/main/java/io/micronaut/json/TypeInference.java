    ...
    private static boolean inferRecursive(Map<TypeVariable<?>, Type> inferred, @Nullable Type generic, @Nullable Type target) {
        if (generic == null) {
            ...
            return target instanceof ParameterizedType &&
                    ...
                    (!isInnerClass((Class<?>) ((ParameterizedType) generic).getRawType()) || inferRecursive(inferred, ((ParameterizedType) generic).getOwnerType(), ((ParameterizedType) target).getOwnerType())) &&
